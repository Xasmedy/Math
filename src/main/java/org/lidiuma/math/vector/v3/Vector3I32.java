...
import org.lidiuma.math.vector.v2.Vector2I32;
import org.lidiuma.math.vector.v4.Vector4I32;
...
public value record Vector3I32(@NullRestricted Integer x,
    ...
    public Vector3I64 asI64() {
        return new Vector3I64((long) x(), (long) y(), (long) z());
    }

    @Override
    public Vector2I32 asV2() {
        return new Vector2I32(x(), y());
    }

    @Override
    public Vector4I32 asV4(Integer w) {
    ...
    @Override
    public Vector3I32 rotate(Vector3I32 axis, Radians angle) {
